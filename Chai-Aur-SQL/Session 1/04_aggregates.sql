CREATE DATABASE smart_watch_sales_db;
USE smart_watch_sales_db;
...
-- C. Show brands that have generated more than 50,000 in revenue
SELECT brand, SUM(units_sold * price_per_unit) AS total_revenue
FROM smart_watch_sales
GROUP BY brand
HAVING SUM(units_sold * price_per_unit) > 50000;
